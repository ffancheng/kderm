...
\textcolor{blue}{We appreciate the reviewer's positive feedback on our manuscript. In response to the suggestion, weclarify that Equation (3) serves as an ``exact'' counterpart of Equation (4). We now state:\\
