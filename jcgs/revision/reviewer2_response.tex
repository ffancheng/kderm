...
\textcolor{blue}{We appreciate the reviewer's positive feedback on our manuscript. In response to the suggestion, we have added \textcolor{red}{[TODO] a short computation in Section 2.3 of the revised manuscript, demonstrating that the density estimator integrates to one when \(H_{i}\) is the true metric matrix at point \(y_{i}\). Additionally, we clarify that formula (3) serves as an "exact" counterpart.} }
...
We believe these changes have strengthened the manuscript, and we are grateful for the reviewer's insights. We hope the revised version meets the standards for publication.
