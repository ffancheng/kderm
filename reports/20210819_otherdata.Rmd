...
```{r, echo = F}
p_tsne <- plot_outlier(x = metric_tsne, n.grid = 50, prob = prob, noutliers = 20, scale = 1/20)
...
```{r, echo = F}
p_umap <- plot_outlier(x = metric_umap, n.grid = 50, prob = prob, noutliers = 20, scale = 1/20)
