...
Motivated by the estimator in \eqref{eq:denriem}, we restate our proposed distortion-corrected kernel density estimator (DC-KDE) of \(f\), same as \eqref{eq:denestimator0}, based on the manifold embedding \(\pmb{y}_i, i = 1, 2, \dots, N\),
\begin{equation}
...
{[}TODO: Further fix the approximation induced by the estimated d\_g so that f will integral to 1.{]}
