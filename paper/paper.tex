...
Motivated on the estimator in \eqref{eq:denriem}, we propose a distortion-corrected kernel density estimator (DC-KDE) of \(f\), same as \eqref{eq:denestimator0}, with the manifold embedding \(\pmb{y}_i, i = 1, 2, \dots, N\) to be
\begin{equation}
