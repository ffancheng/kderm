...
\hypertarget{vkde}{%
\section{Kernel density estimation on manifold learning embeddings}\label{vkde}}
...
\hypertarget{dckde}{%
\section{Distotion-corrected kernel density estimator (DC-KDE)}\label{dckde}}
...
\hypertarget{volume-density-function-move-to-section-2.2.1}{%
\subsection{Volume density function {[}MOVE TO SECTION 2.2.1{]}}\label{volume-density-function-move-to-section-2.2.1}}
...
\hypertarget{example-of-s1-for-manifold-density-estimation}{%
\subsection{\texorpdfstring{Example of \(S^1\) for manifold density estimation}{Example of S\^{}1 for manifold density estimation}}\label{example-of-s1-for-manifold-density-estimation}}
