...
\multicolumn{1}{c}{ } & \multicolumn{1}{c}{ISOMAP} & \multicolumn{1}{c}{LLE} & \multicolumn{1}{c}{Laplacian Eigenmaps} & \multicolumn{1}{c}{t-SNE} & \multicolumn{1}{c}{UMAP} & \multicolumn{1}{c}{ISOMAP} & \multicolumn{1}{c}{LLE} & \multicolumn{1}{c}{Laplacian Eigenmaps} & \multicolumn{1}{c}{t-SNE} & \multicolumn{1}{c}{UMAP} \\
...
1 & \textcolor{black}{6317} & \textcolor{black}{7049} & \textcolor{black}{3161} & \textcolor{black}{4826} & \textcolor{black}{4546} & \textcolor{black}{6317} & \textcolor{black}{1881} & \textcolor{black}{6317} & \textcolor{black}{4190} & \textcolor{black}{6533}\\
2 & \textcolor{0}{1353} & \textcolor[HTML]{08306B}{\textbf{4546}} & \textcolor[HTML]{08306B}{\textbf{5269}} & \textcolor{0}{1069} & \textcolor[HTML]{08306B}{\textbf{7049}} & \textcolor{0}{4884} & \textcolor{0}{6199} & \textcolor{0}{6643} & \textcolor{0}{6817} & \textcolor{0}{5899}\\
3 & \textcolor{0}{4884} & \textcolor[HTML]{08306B}{\textbf{1881}} & \textcolor{0}{4875} & \textcolor{0}{4546} & \textcolor[HTML]{08306B}{\textbf{1069}} & \textcolor{0}{5092} & \textcolor[HTML]{6BAED6}{\textbf{5356}} & \textcolor{0}{6764} & \textcolor{0}{6492} & \textcolor{0}{6345}\\
4 & \textcolor{0}{4546} & \textcolor{0}{6952} & \textcolor{0}{7300} & \textcolor[HTML]{08306B}{\textbf{7049}} & \textcolor{0}{4862} & \textcolor{0}{1353} & \textcolor[HTML]{6BAED6}{\textbf{4233}} & \textcolor{0}{1058} & \textcolor{0}{2309} & \textcolor{0}{1884}\\
5 & \textcolor[HTML]{08306B}{\textbf{7049}} & \textcolor{0}{6838} & \textcolor{0}{4880} & \textcolor[HTML]{08306B}{\textbf{1533}} & \textcolor{0}{3639} & \textcolor{0}{5580} & \textcolor{0}{7049} & \textcolor{0}{5105} & \textcolor{0}{2546} & \textcolor{0}{3278}\\
\addlinespace
6 & \textcolor[HTML]{08306B}{\textbf{1366}} & \textcolor{0}{3874} & \textcolor{0}{5599} & \textcolor[HTML]{6BAED6}{\textbf{4265}} & \textcolor{0}{1964} & \textcolor{0}{5594} & \textcolor[HTML]{08306B}{\textbf{1821}} & \textcolor{0}{6577} & \textcolor{0}{2907} & \textcolor{0}{5463}\\
7 & \textcolor{0}{3161} & \textcolor{0}{1069} & \textcolor{0}{3222} & \textcolor{0}{4862} & \textcolor[HTML]{6BAED6}{\textbf{2249}} & \textcolor{0}{2576} & \textcolor{0}{4546} & \textcolor{0}{3880} & \textcolor{0}{4536} & \textcolor{0}{5504}\\
8 & \textcolor[HTML]{08306B}{\textbf{1074}} & \textcolor{0}{2249} & \textcolor{0}{1776} & \textcolor{0}{3639} & \textcolor{0}{6199} & \textcolor{0}{1366} & \textcolor[HTML]{08306B}{\textbf{3431}} & \textcolor{0}{5358} & \textcolor{0}{6898} & \textcolor{0}{1782}\\
9 & \textcolor{0}{6681} & \textcolor{0}{1964} & \textcolor{0}{1161} & \textcolor{0}{5546} & \textcolor[HTML]{6BAED6}{\textbf{3892}} & \textcolor{0}{6681} & \textcolor{0}{1569} & \textcolor{0}{1366} & \textcolor{0}{4128} & \textcolor{0}{5965}\\
10 & \textcolor{0}{1701} & \textcolor[HTML]{6BAED6}{\textbf{1569}} & \textcolor{0}{3655} & \textcolor{0}{4896} & \textcolor{0}{6209} & \textcolor{0}{5291} & \textcolor{0}{1964} & \textcolor{0}{5545} & \textcolor{0}{7368} & \textcolor{0}{6081}\\
\addlinespace
11 & \textcolor{0}{3136} & \textcolor{0}{1533} & \textcolor{0}{6169} & \textcolor{0}{4555} & \textcolor{0}{6952} & \textcolor{0}{3161} & \textcolor[HTML]{6BAED6}{\textbf{6568}} & \textcolor{0}{2160} & \textcolor{0}{2232} & \textcolor{0}{4894}\\
12 & \textcolor{0}{1881} & \textcolor[HTML]{6BAED6}{\textbf{4555}} & \textcolor{0}{4830} & \textcolor{0}{6199} & \textcolor{0}{4896} & \textcolor[HTML]{08306B}{\textbf{1701}} & \textcolor{0}{7300} & \textcolor{0}{6585} & \textcolor{0}{6273} & \textcolor{0}{5937}\\
13 & \textcolor{0}{6785} & \textcolor{0}{6526} & \textcolor{0}{2284} & \textcolor[HTML]{6BAED6}{\textbf{6952}} & \textcolor{0}{6838} & \textcolor{0}{4749} & \textcolor{0}{7438} & \textcolor{0}{5824} & \textcolor{0}{1557} & \textcolor{0}{5522}\\
14 & \textcolor{0}{5092} & \textcolor{0}{3639} & \textcolor{0}{6526} & \textcolor{0}{6838} & \textcolor{0}{1533} & \textcolor{0}{6699} & \textcolor{0}{4401} & \textcolor{0}{4932} & \textcolor{0}{3500} & \textcolor{0}{5580}\\
15 & \textcolor{0}{5269} & \textcolor{0}{6199} & \textcolor{0}{1694} & \textcolor{0}{1964} & \textcolor[HTML]{6BAED6}{\textbf{1569}} & \textcolor{0}{5504} & \textcolor{0}{3434} & \textcolor{0}{6410} & \textcolor{0}{1932} & \textcolor{0}{6902}\\
\addlinespace
16 & \textcolor{0}{2576} & \textcolor[HTML]{6BAED6}{\textbf{5531}} & \textcolor{0}{3431} & \textcolor[HTML]{6BAED6}{\textbf{7104}} & \textcolor{0}{3213} & \textcolor{0}{3170} & \textcolor{0}{2249} & \textcolor{0}{3023} & \textcolor{0}{3119} & \textcolor{0}{7243}\\
17 & \textcolor{0}{1262} & \textcolor{0}{4875} & \textcolor{0}{2523} & \textcolor{0}{3892} & \textcolor{0}{4401} & \textcolor{0}{5899} & \textcolor{0}{3213} & \textcolor{0}{1497} & \textcolor{0}{3809} & \textcolor{0}{6699}\\
18 & \textcolor{0}{5966} & \textcolor{0}{5356} & \textcolor{0}{5356} & \textcolor{0}{3161} & \textcolor{0}{6766} & \textcolor{0}{2658} & \textcolor{0}{3161} & \textcolor{0}{7293} & \textcolor{0}{6108} & \textcolor{0}{5549}\\
19 & \textcolor{0}{5937} & \textcolor[HTML]{6BAED6}{\textbf{3892}} & \textcolor[HTML]{6BAED6}{\textbf{2233}} & \textcolor[HTML]{08306B}{\textbf{6799}} & \textcolor{0}{4265} & \textcolor{0}{5189} & \textcolor[HTML]{08306B}{\textbf{1533}} & \textcolor{0}{5580} & \textcolor{0}{4516} & \textcolor{0}{5048}\\
20 & \textcolor{0}{5356} & \textcolor{0}{4896} & \textcolor{0}{5125} & \textcolor{0}{6209} & \textcolor{0}{6799} & \textcolor{0}{2669} & \textcolor[HTML]{6BAED6}{\textbf{4555}} & \textcolor{0}{6224} & \textcolor{0}{5937} & \textcolor{0}{1923}\\
\bottomrule
\end{tabu}
\end{table}
...
\centering
\resizebox{\linewidth}{!}{
\begin{tabu} to \linewidth {>{\raggedright}X|>{}c>{}c|>{}c>{}c|>{}c>{}c|>{}c>{\centering}X}
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{ISOMAP} & \multicolumn{2}{c}{LLE} & \multicolumn{2}{c}{Laplacian Eigenmaps} & \multicolumn{2}{c}{t-SNE} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){6-7} \cmidrule(l{3pt}r{3pt}){8-9}
\multicolumn{1}{c}{HDRs} & \multicolumn{1}{c}{DC-KDE} & \multicolumn{1}{c}{KDE} & \multicolumn{1}{c}{DC-KDE} & \multicolumn{1}{c}{KDE} & \multicolumn{1}{c}{DC-KDE} & \multicolumn{1}{c}{KDE} & \multicolumn{1}{c}{DC-KDE} & \multicolumn{1}{c}{KDE} \\
...
>99\% HDR & \cellcolor[HTML]{E6E6E6}{0.189} & 0.243 & \cellcolor[HTML]{E6E6E6}{0.189} & 0.027 & \cellcolor[HTML]{E6E6E6}{0.622} & 0.000 & \cellcolor[HTML]{E6E6E6}{0.865} & 0.108\\
99\% HDR & \cellcolor[HTML]{E6E6E6}{0.359} & \textbf{0.248} & \cellcolor[HTML]{E6E6E6}{\textbf{0.503}} & 0.000 & \cellcolor[HTML]{E6E6E6}{\textbf{0.697}} & 0.007 & \cellcolor[HTML]{E6E6E6}{\textbf{0.628}} & 0.083\\
\bottomrule
\end{tabu}}
\end{table}
\begin{figure}
...
Unlike the simulations where the ground truth densities are known, in the applications, we usually have little knowledge about the anomalous distributions of the households. Therefore, we assume, in this case, the anomalies given by UMAP are the `true' ones and evaluate the performance of the other four dimension reduction methods, ISOMAP, LLE, Laplacian Eigenmaps and t-SNE. The results are summarized in \autoref{tab:electricityhdrpercent} similar to \autoref{tab:fourdhdrtable}. \autoref{tab:electricityhdrpercent} presents the proportions of `true' outliers (given by UMAP) in \(>99\%\) and \(99\%\) HDRs that are also identified in different dimension reduction methods. Both DC-KDE and KDE are shown in the table. Except the lower percentage of ISOMAP in \(>99\%\) HDRs, distortion corrected KDE gives higher proportions of true outliers in all other methods. The improvement brought by distortion correction is much more obvious in Laplacian Eigenmaps and t-SNE when the increase in both HDRs are greater than \(0.5\).
\autoref{fig:electricityrank} presents the visualization of density ranking in log scale. The grey shading area covers the density rank from 1 to 20, which are the anomalies listed in \autoref{tab:electricityoutliers}. Again, the plots show the robustness of density estimated with distortion correction regardless of the dimension reduction methods.
...
Now let us take a close look at the typical and anomalous distributions of households. According to \autoref{tab:electricityoutliers}, we pick the three dark blue indexes that are identified as anomalies the most times, which are Household 3161, 4546, 7049, as well as the most typical household with the highest density estimate, Households 2396, for illustration. Their half-hourly electricity demands across the entire trial period are plotted in \autoref{fig:electricityraw}. Compared with ID 2396, the other three households show different usage patterns. ID 3161 has much less electricity usage in summers, mostly below 1kWh, than in winters, above 3kWh. As this data set does not include the energy used for cooling or heating systems, it is possible that there are other large electronic appliances used in winter for this household. The other two anomalous IDs, 4546 and 7049, however, have nearly zero kWh electricity consumption for many days and some spikes for other days. It is likely that these two households are not occupied all the time during the trial and could be used as a AirBnb place or holiday place.
...
Further insights could be gained by comparing the quantile region plots of electricity demand against the time of the week for the same typical or anomalous households in \autoref{fig:electricityoutliers}. The distribution of the typical households in the top panel has shown a repeated period-of-the-week usage pattern, with higher usage during mealtime on all seven days of the week and slightly higher usage for weekends.
This repeated pattern in a week window is also shown in some days of week for household ID 3161 with small spikes at noon and midnight but not on Fridays and Saturdays. As for the bottom two households, the middle row in \autoref{fig:electricityhdrsfixed} shows a distribution with zero median and a \(75\%\) quantile of 1kWh from around 9pm to 6am, while the distributions for ID 7049 does not have an obvious pattern across different periods of the week. These findings show that distortion correction methods work well in estimating the densities of the electricity usage and detecting anomalous households in the smart meter data despite the various embeddings from different dimension reduction methods.
