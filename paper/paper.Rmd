...
\begin{algorithm}[!htb]
  ...
  \OptParameter{ manifold learning parameters $MANILEARN$}
  \BlankLine
  \begin{algorithmic}[1]
...
Now we are able to generate kernel density estimates of the underlying manifold using the estimator in Equation \@ref(eq:denestimator).
