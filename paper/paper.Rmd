...
This is shown on the right panel of \autoref{fig:mappings}. We also considered the 'Swiss Roll' mapping shown on the left panel of \autoref{fig:mappings}, the results for this manifold are summarised in \autoref{swissrollappe}.
...
```{r tpisomapvs4ml, fig.align = 'center', out.width = "95%", fig.cap="Comparison of ranked densities found by ISOMAP and other four manifold learning methods for DC-KDE (on the left panel) and KDE (on the right panel).", echo = FALSE}
