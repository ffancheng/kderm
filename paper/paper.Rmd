...
```{r tpisomapden, fig.align = 'center', out.width = "95%", fig.cap="Scatterplot of true density and estimated density ranks of ISOMAP embedding for KDE with both variable and fixed bandwidth. The four colors and shapes represents the four gaussian kernels in the 2-D meta data. DC-KDE shows a strong linear positive relationship.", echo = FALSE}
knitr::include_graphics("figures/Twin Peak2000_density_isomap_r0_5_rank.png")
```
