...
as_tibble(cors, rownames = " ") %>% 
  mutate_if(is.numeric, format, digits = 3, nsmall = 3) %>% 
  kableExtra::kbl(caption = "Correlation between true density and estimated density for four manifold learning embeddings. Variable bandwidth always outperfoms fixed bandwidth although they both have negative correlations in UMAP.", booktabs = TRUE, digits = 3, escape = FALSE) %>%
