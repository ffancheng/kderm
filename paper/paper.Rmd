...
<!-- 5x2 HDRs plot of vkde and hdr, 5levels, 5 ML methods, kdtrees, eps=1 -->
<!-- index top 20 outliers -->
<!-- compare density ranking of VKDE and HDR,  -->
<!-- scatterplot no colors, table with one row for 5 ML methods -->


<!-- top 1 typical points + top 2 outlier, HDR -->
<!-- top 1 typical points + top 2 outlier, VKDE -->
<!-- raw data plot side by side -->
<!-- density plot in two figures -->
