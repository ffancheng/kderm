...
As pointed out by @Perrault-Joncas2013-pq, if the dimension reduction is carried out such that the dimension of the output vectors is larger than the manifold intrinsic dimension $d$, the rank of the embedding metric $\pmb{H}(p)$ is equal to $d$; otherwise, the Riemannian metric will be returned. 
